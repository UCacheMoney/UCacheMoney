...
class Child(UserBase):
    def __init__(self, name, email, parentID):
        ...
        self.parent = (
            Parent()
        )  # gets parent object from parent ID once database is working
    ...
    def reachingLimit(self):
        ...
        functions.sendEmail(
            (self.parent).getEmail(),
            "Child Is Reaching Spending Limit",
